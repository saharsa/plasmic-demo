...
import * as sty from "./PlasmicAuthorBio.module.css"; // plasmic-import: Ir9BXL_Or7DIA/css
  ...
  return (
    ...
    >
      {p.renderPlasmicSlot({
        defaultContents: (
          <PlasmicLogoIcon
            className={classNames(defaultcss.all, sty.svg__rmyMt)}
            role={"img"}
          />
        ),
